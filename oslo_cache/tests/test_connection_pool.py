...
class TestMemcacheClientPool(test_cache.BaseTestCase):
    ...
    def test_memcache_client_pool_create_connection_single_url(self):
        mcp = _memcache_pool.MemcacheClientPool(urls="http://bar:11211",
                                                arguments={},
                                                maxsize=10,
                                                unused_timeout=10)
    ...
    def test_retry_backward_compat(self, mock_deprecate):
        ...
        mcp._create_connection()

    @mock.patch("debtcollector.deprecate")
    def test_retry_backward_compat2(self, mock_deprecate):
        args = {
            'dead_retry': 99,
        }
        mcp = _memcache_pool.MemcacheClientPool(urls=['foo'],
    ...
    @mock.patch("debtcollector.deprecate")
    def test_pickler_backward_compat2(self, mock_deprecate):
        args = {
            'serializer': fake_serializer,
            'pickler': fake_pickler,
        }
    ...
    @mock.patch("debtcollector.deprecate")
    def test_unpickler_backward_compat2(self, mock_deprecate):
        args = {
            'deserializer': fake_deserializer,
            'unpickler': fake_unpickler,
        }
    ...
    def test_timeout_backward_compat(self, mock_deprecate):
        ...
        mock_deprecate.assert_called_with(
            ...
            "longer supported. Prefer to use `connect_timeout` instead."
        )
        self.assertNotIn('socket_timeout', mcp._arguments)
        self.assertIn('connect_timeout', mcp._arguments)
        self.assertEqual(66, mcp._arguments['connect_timeout'])

        mcp._create_connection()

    @mock.patch("debtcollector.deprecate")
    def test_timeout_backward_compat2(self, mock_deprecate):
        args = {
            'socket_timeout': 66,
            'connect_timeout': 12,
        }
        ...
        self.assertNotIn('socket_timeout', mcp._arguments)
        self.assertIn('connect_timeout', mcp._arguments)
        self.assertEqual(12, mcp._arguments['connect_timeout'])
